...
var deletePossibleAnswers = function () {

    describe('Test possible_answers.deleteAllAnswers()', function () {
        ...
        it('should delete all possible answers', function () {
            ...
            //should only have default possible answer
            expect(input.possible_answers).to.have.lengthOf(1);
            expect(input.possible_answers[0].answer).to.equal(consts.POSSIBILE_ANSWER_PLACEHOLDER);
            ...
            expect(formbuilder.dom.input_properties_forms_wrapper.find('.input-properties__form__possible-answers__list__remove-answer'))
                .to.be.disabled;
...
module.export = deletePossibleAnswers();
